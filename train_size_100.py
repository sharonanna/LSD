...
PIN_MEMORY = False
LOAD_MODEL = False
TRAIN_IMG_DIR = "train_data_B100/train_images/"
TRAIN_MASK_DIR = "train_data_B100/train_masks/"
VAL_IMG_DIR = "train_data_B100/val_images/"
VAL_MASK_DIR = "train_data_B100/val_masks/"
SLOPE_DIR = "train_data_B100/slope_images"


def train_fn(loader, model, optimizer, loss_fn, scaler, slope_factor):
    loop = tqdm(loader)
    writer = SummaryWriter("slope100")
    iter = 0
