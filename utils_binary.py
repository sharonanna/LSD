...
def save_checkpoint(state, filename="checkpoint_exp7_combined_binary.pth.tar"):
...
#             preds = (preds > 0.5).float()
#             np.save('predictions_exp7_5_binary/tm_pred'+str(idx)+'.npy',preds)
#             np.save('predictions_exp7_5_binary/tm_y'+str(idx)+'.npy',y)
