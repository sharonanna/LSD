...
def save_checkpoint(state, filename="checkpoint_exp7_300_5.pth.tar"):
...
#             preds = (preds > 0.5).float()
#             np.save('predictions_exp7_300_5/tm_pred'+str(idx)+'.npy',preds)
#             np.save('predictions_exp7_300_5/tm_y'+str(idx)+'.npy',y)
